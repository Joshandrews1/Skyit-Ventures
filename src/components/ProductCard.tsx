        ...
        <div className="flex flex-col gap-2 pt-2 border-t border-slate-50">
          ...
          <div className="flex items-center justify-between gap-1.5">
            <div className="flex flex-col min-h-[34px] justify-center">
              {product.discountPercent > 0 && (
                <span className="text-[10px] sm:text-[11px] text-slate-400 line-through font-sans leading-none mb-0.5">
                  ₦{product.originalPrice?.toLocaleString('en-US').replace(/[\s\u00A0\u202F]+/g, '')}
                </span>
              )}
              <span className="text-[13px] sm:text-[15px] font-bold font-sans text-slate-900 leading-none tracking-tight">
