...
export const CartSidebar: React.FC<CartSidebarProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex justify-end z-[1000] animate-fade-in">
      <div className="bg-white w-full sm:w-[440px] sm:max-w-md h-full h-[100dvh] flex flex-col justify-between shadow-2xl relative border-l border-slate-200 text-slate-600">
               {/* Header */}
