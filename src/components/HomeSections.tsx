...
export const HomeSections: React.FC<HomeSectionsProps> = ({ onSelectCategory, onNavigate }) => {
  return (
    <div className="space-y-16 py-6">
      ...
      <section className="bg-slate-50/70 border border-slate-200/60 rounded-3xl py-10 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10 flex-1 space-y-4">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 bg-brand-light hover:bg-brand/20 rounded-full text-[9px] font-extrabold text-brand border border-brand/20 uppercase tracking-wide transition-all cursor-pointer shadow-2xs"
                  title="View complete product catalog"
                >
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <button
                  ...
                  className="text-[10px] font-bold text-brand hover:underline mt-2 inline-flex items-center gap-0.5 cursor-pointer"
                >
